function [electrons] = compute_electron_positions_w_pillbox(electrons, L, W, d_t, box)
    ...
    [electrons] = correct_out_of_region_rethermalized(electrons, x_temp, y_temp, L, W);
...
function [electrons] = correct_out_of_region_rethermalized(electrons, x_temp, y_temp, L, W)
    find_gt = @(a,b) (a > b);
    find_lt = @(a,b) (a < b);
