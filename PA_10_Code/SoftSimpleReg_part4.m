...
% Answer to question 4 part a: Here I went kind of simple. I basically made
% a hollow square.

% Answer to question 4 part b: Unfortunately I could not find the place in
% the code to do this. I tried looking though :^(
...
epi{1}(85:110,55:95)= c_eps_0*11.3;
epi{1}(110:125,85:95)= c_eps_0*11.3;
epi{1}(110:125,55:65)= c_eps_0*11.3;
